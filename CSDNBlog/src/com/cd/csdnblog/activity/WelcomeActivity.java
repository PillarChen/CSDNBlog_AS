...
import com.cd.csdnblog.adapter.BasePagerAdapter;
...
//		new CreateShut(this);
		...
		images = new int[] {R.drawable.splash_recommendblog, R.drawable.splash_managerblog,R.drawable.splash_addblog,R.drawable.splash_myblog};
		initView();
	}
